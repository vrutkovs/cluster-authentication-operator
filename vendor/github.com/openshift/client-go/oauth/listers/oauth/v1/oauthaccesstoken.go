...
type OAuthAccessTokenLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*oauthv1.OAuthAccessToken, err error)
	// Get retrieves the OAuthAccessToken from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*oauthv1.OAuthAccessToken, error)
